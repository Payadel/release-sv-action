...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield Inputs_1.Inputs.Get().then(inputs => {
                Inputs_1.Inputs.exportInputsInTestMode(inputs);
                return setGitConfigs(inputs.gitEmail, inputs.gitUsername)
                    .then(() => installStandardVersionPackage())
                    .then(() => release(inputs.inputVersion, inputs.skipChangelog, inputs.isTestMode))
